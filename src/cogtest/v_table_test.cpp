...
#include "cog/v_exception.h"
#include "cog/vm_value.h"

using namespace Cog::Verbs;
...
Case(TestClass)
{
	...
	std::stack<Cog::VirtualMachine::Value> stack;
...
Case(ReturnType)
{
	...
	table.AddVerb("Vector", ZeroVerb<Cog::Generics::Vector<float>>);
