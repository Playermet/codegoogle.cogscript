...
Case(AddSymbol)
{
	...
	table.AddSymbol(Cog::Symbols::Type::Int, "foo", Value(10),
		true, "desc", 0, 0, true);
}
...
Case(GetSymbolByIndex)
{
	...
	table.AddSymbol(Cog::Symbols::Type::Int, "foo", Value(10),
		true, "desc", 0, 0, true);
	table.AddSymbol(Cog::Symbols::Type::Int, "bar", Value(20),
		true, "desc", 0, 0, true);
	table.AddSymbol(Cog::Symbols::Type::Int, "baz", Value(30),
		true, "desc", 0, 0, true);
...
Case(SymbolRedefinition)
{
	...
	try
	{
		table.AddSymbol(Cog::Symbols::Type::Int, "foo", Value(20),
			true, "desc", 0, 0, true);
	}
