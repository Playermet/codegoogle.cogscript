#ifndef _AST_VISITOR_H_INCLUDED_
#define _AST_VISITOR_H_INCLUDED_
...
#define AVDEFAULTACTION(x) void Cog::AST::Visitor::Visit##x(x& e) { DefaultAction(#x, e); }
...
namespace Cog
{
	namespace AST
	{
		...
		protected:
			...
			Visitor(const std::string& name, Error::Report& report);
...
#endif // _AST_VISITOR_H_INCLUDED_
